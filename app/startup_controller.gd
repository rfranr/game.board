...
#var _DependencyHelper = preload("res://app/dependency_helper.gd")
#var _ScenesController = preload("res://app/scenes_controller.gd")
#var _GameController = preload("res://app/game_controller.gd")
